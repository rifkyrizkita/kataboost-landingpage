    ...
    <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Effective Date: {effective} • Last Updated: {effective}</p>
        </div>
        ...
        <div className="prose prose-slate max-w-none">
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">3. AI and Data Handling</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">5. Cross-Border Data Transfers</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">12. Contact DPO</h2>
