        ...
        <div className="prose prose-slate max-w-none">
          <div className="space-y-8 text-gray-300">
            <section>
              ...
              <p>
                By accessing or using our website (<a href="https://www.kataboost.com" target="_blank" rel="noreferrer" className="text-primary hover:underline">www.kataboost.com</a>) and related products or services (collectively, the "Service"), you agree to be bound by these Terms of Service ("Terms") and our Privacy Policy. If you do not agree, please discontinue use immediately.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">1. Overview of the Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">3. Account Registration and Access</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">6. AI and Data Usage</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">11. Suspension or Termination</h2>
              <p>
